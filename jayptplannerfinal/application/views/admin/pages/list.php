	...
	?>
        ...
        <div class="row">
			...
			<div id="editable-sample_wrapper" class="dataTables_wrapper form-inline" role="grid">		
				    ...
				    <th>Page Title</th>
                                    <th>Status</th>
                                    <!--<th><img src="<?php echo site_url();?>assets/admin/img/eng.ico" alt="" style="height: 16px; width: 16px;"></th>-->
				   <?php
				       if(isset($langs))
				       {
				   ...
				   ?>
				    <!--<th><img src="<?php echo site_url();?>assets/admin/img/spanish.ico" alt="" style="height: 16px; width: 16px;"></th>-->
				...
				?>
				   ...
				   ?>
				    <!--<td><a href="<?php echo site_url("control").'/pages/updatelang/'.$row['id']; ?>"><i class="fa fa-edit"></i></a></td>-->
                                </tr>
				<?php } ?>
                                </tbody>
