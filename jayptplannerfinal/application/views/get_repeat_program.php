<form action="<?php echo base_url(); ?>toolbox/add_repeat" method="post" name="repeat_prgm_frm">
...
<input type="hidden" id="repeat_program_id" name="repeat_program_id" value="<?php echo $user_program_id; ?>">
<input type="hidden" id="client_id" name="client_id" value="<?php echo $client_id; ?>">
<input type="hidden" id="trainer_id" name="trainer_id" value="<?php echo $trainer_id; ?>">
<div class="name-group clearfix">
        <label style="text-align: left;">REPEAT PROGRAMME</label>
</div>
 <div class="name-group clearfix">
