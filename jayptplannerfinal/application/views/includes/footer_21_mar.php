...
<script type="text/javascript" src="<?php echo base_url();?>assets/admin/js/bootstrap-fileupload/bootstrap-fileupload.js"></script>
...
<!--Morris Chart-->
<!--<script src="<?php echo base_url();?>assets/admin/js/morris-chart/morris.js"></script>


<script src="<?php echo base_url();?>assets/admin/js/morris-chart/raphael-min.js"></script>-->
...
<script src="<?php echo base_url();?>assets/admin/js/flot-chart/jquery.flot.animator.min.js"></script>
<script src="<?php echo base_url();?>assets/admin/js/flot-chart/jquery.flot.growraf.js"></script>-->
