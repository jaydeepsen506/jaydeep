...
<head>
    ...
    <?php if($page == 'homepage'){ ?> &nbsp;Home Page <?php } ?>
    ...
    <?php  if($page == 'manageclient'){ ?> &nbsp;Client Management <?php } ?>
    <?php  if($page == 'managetestimonials'){ ?> &nbsp;Testimonials Management <?php } ?>
    <?php  if($page == 'user'){ ?> &nbsp;User Management <?php } ?>
    <?php  if($page == 'network'){ ?> &nbsp;Network Management <?php } ?>
    <?php  if($page == 'meal_management'){ ?> &nbsp;Meal management <?php } ?>
    <?php  if($page == 'exercise'){ ?> &nbsp;Exercise <?php } ?>
    <?php  if($page == 'booking'){ ?> &nbsp;Booking <?php } ?>
    <?php  if($page == 'program'){ ?> &nbsp;Program <?php } ?>
...
<div class="brand">
    ...
    <a href="<?php echo base_url(); ?>index.php/control/dashboard" class="logo">
       
        <img src="http://esolz.co.in/lab6/ptplanner/assets/admin/images/logo_nav.png" alt="Your logo" width="195">
       ...
       <!-- <li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                <li><a href="<?php echo base_url(); ?>index.php/control/myaccount"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="<?php echo base_url(); ?>index.php/control/contactsetting"><i class="fa fa-cog"></i>Contact Settings</a></li>
                <li><a href="<?php echo base_url(); ?>index.php/control/logout"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a <?php if($page == 'dashboard'){ ?> class="active" <?php } ?> href="<?php echo base_url(); ?>index.php/control/dashboard">
                        <i class="fa fa-dashboard"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li>
                    <a <?php if($page == 'myaccount'){ ?> class="active" <?php } ?> href="<?php echo base_url(); ?>index.php/control/myaccount">
                        <i class="fa fa-th"></i>
                        <span>My Info </span>
                    </a>
                </li>
		<li>
                    <a <?php if($page == 'chngpassword'){ ?> class="active" <?php } ?> href="<?php echo base_url(); ?>index.php/control/chngpassword">
                        <i class="fa fa-th"></i>
                        <span>Change Password </span>
                    </a>
                </li>
		<li class="sub-menu">
                    <a href="javascript:;" <?php if(($page == 'sitesetting') || (($page == 'homepage')) || (($page == 'contactsetting')) || (($page == 'social_site'))){ ?> class="active" <?php } ?>>
                        <i class="fa fa-book"></i>
                        <span>Settings</span>
                    </a>
                    <ul class="sub">
                        <li <?php if($page == 'sitesetting'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/sitesetting">Site Settings</a></li>
		
		 <li <?php if($page == 'homepage'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/homepage">Home page</a></li>
		 
                        <li <?php if($page == 'contactsetting'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/contactsetting">Contact Settings</a></li>
                    </ul>
                </li>
		<li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li <?php if($page == 'pages'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/pages">Manage Pages</a></li>
                    </ul>
                </li>
		<li class="sub-menu">
                    <a href="javascript:;" <?php if(($page == 'managecontact')||($page == 'managetrainer')|| ($page == 'manageclient') ||($page == 'managetestimonials') || ($page == 'email_template_management') || ($page == 'network') || ($page == 'meal_management') || ($page == 'exercise') || ($page == 'booking') || ($page == 'program')){ ?> class="active" <?php } ?>>
                        <i class="fa fa-book"></i>
                        <span>Admin Tools</span>
                    </a>
                    <ul class="sub">
                        <li <?php if($page == 'managecontact'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/managecontact">Manage Contacts</a></li>
			<li <?php if($page == 'managetrainer'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/managetrainer">Manage Trainer</a></li>
			<li <?php if($page == 'manageclient'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/manageclient">Manage Client</a></li>
			<li <?php if($page == 'managetestimonials'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/managetestimonials">Manage Testimonial</a></li>
			<li <?php if($page == 'email_template_management'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/email_template_management">Manage Email Template</a></li>
			<li <?php if($page == 'network'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/network">Manage Network</a></li>
			<li <?php if($page == 'meal_management'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/meal_management">Meal Management</a></li>
			<li <?php if($page == 'exercise'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/exercise">Exercise </a></li>
			<li <?php if($page == 'booking'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/booking">Booking </a></li>
			<li <?php if($page == 'program'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/program">Program </a></li>
			<li <?php if($page == 'storedetails'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/store">Store Details</a></li>
		 	<li <?php if($page == 'branddetails'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/">Brand Details</a></li>
                        <li <?php if($page == 'productdetails'){ ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>index.php/control/product">Product Details</a></li>
                    </ul>
                </li>   
