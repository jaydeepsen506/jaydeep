    ...
    ?>
        ...
        <div id="d2">
		 <div class="panel-body">
			<div class="clearfix">
                                <div class="btn-group">
				    <button class="btn btn-primary" onclick="location.href='<?php echo site_url('control'); ?>/managetestimonials/add';">
			...
			<div class="adv-table">
				...
				?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo site_url("control").'/managetestimonials/edit/'.$row->id; ?>"><?php echo $row->name ?></a></td>
                                    <td><?php if($row->status=='Y'){ echo "ACTIVE";} else {echo "BLOCK";}?></td>
				     <td>
					<a class="fa fa-edit" href="<?php echo site_url("control").'/managetestimonials/edit/'.$row->id; ?>" onclick="b()" > </a>
                                    </td>
						    ...
						    <div class="modal fade" id="myModal<?php  echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							    ...
							    <div class="modal-body">
							       ...
							       <div class="modal-footer">
								    ...
								    <button class="btn btn-warning" type="button" onclick="location.href='<?php echo site_url("control").'/managetestimonials/delete/'.$row->id; ?>';"> Confirm</button>
								</div>
							       </div>											    
							    </div>				
						     </div>	     
