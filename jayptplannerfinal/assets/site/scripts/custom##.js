	...
	$('#forgetpassword_form').submit(function() {
		...
		$.ajax({
			...
			if (data == "forget_mail_send")
			{
				...
				//Use modal popups to display messages
				$('#modalMessage .modal-title').html('<i class="icon icon-ban"></i>Oops!<br>Something went wrong!'+data);
				$('#modalMessage').modal('show');	
			}
				...
				//Use modal popups to display messages
				$('#modalMessage .modal-title').html('<i class="icon icon-ban"></i>Oops!<br>User not exist!'+data);
				$('#modalMessage').modal('show');	
			}
		    },
		    error: function() {
...
//------------------------------------------------------------------------------------
//						RESET FORM VALIDATION'S SETTINGS
//------------------------------------------------------------------------------------		  
